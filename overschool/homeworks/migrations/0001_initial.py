    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('homework_id', models.ForeignKey(help_text='ID домашнего задания, ответ на который прислали', on_delete=django.db.models.deletion.CASCADE, related_name='user_homework_homework_id_fk', to='homeworks.homework', verbose_name='ID домашнего задания')),
            ],
            options={
